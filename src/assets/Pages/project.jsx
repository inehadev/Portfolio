...
import { SiFirebase , SiCss3 ,SiChakraui ,SiMongodb  , SiExpress} from 'react-icons/si';

export default function Project (){
    return (
        <Flex bg={useColorModeValue('gray.100', 'gray.900')} flexDirection={"column"} px={4} mt={3} borderRadius={"15px"} m={"20px"}  h={{base:"3540px" , md : "1530px"}} >
